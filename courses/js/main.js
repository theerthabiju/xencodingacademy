...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        var swiperCourse = new Swiper(".course-carousel-home-2", {
            slidesPerView: 3,
            spaceBetween: 24,
            loop: true,
            speed: 600,
        ...
        var swiperCourse = new Swiper(".team-section-ex-2-wrap", {
            slidesPerView: 4,
            spaceBetween: 24,
            loop: true,
            speed: 600,
        ...
        var swiperCourse = new Swiper(".team-section-ex-2-wrap-6", {
            slidesPerView: 5,
            spaceBetween: 24,
            loop: true,
            speed: 600,
        ...
        var swiperCourse = new Swiper(".category-ex-h2", {
            slidesPerView: 4,
            spaceBetween: 24,
            loop: true,
            speed: 600,
        ...
        var swiperTesti = new Swiper(".testi-carousel-ex-9", {
            slidesPerView: 2,
            spaceBetween: 24,
            slidesPerGroup: 1,
            loop: true,
    ...
    function updateActiveShape(idx) {
        ...
        // guard: যদি স্লাইড > শেপ হয়, modulo নিন
    ...
    // bonus: শেপে ক্লিক করলে সেই স্লাইডে যাওয়া
